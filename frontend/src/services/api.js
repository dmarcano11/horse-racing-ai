...
// Meets
export const getMeetsByDate = (date) =>
  api.get('/meets', { params: { date } })
...
// Results
export const getResultsForRace = (raceId) =>
  api.get(`/results/race/${raceId}`)
